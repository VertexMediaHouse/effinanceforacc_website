            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid gap-8 lg:grid-cols-[380px_1fr]">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <button className="flex w-fit items-center gap-2 rounded-md bg-[#cd753a] px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#b8662f]">
                            Check Our Reviews
                            <ArrowRight size={16} />
                        </button>
                    </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        {testimonials.map((item, index) => (
                            <div
                                key={index}
                                className="relative overflow-hidden rounded-2xl bg-white border border-[#f0e6dd] p-7 shadow-[0_4px_24px_rgba(205,117,58,0.06)]"
                            >
                                {/* Stars */}
