    ...
    <>
      <nav className="bg-[#0e6655] sticky top-0 z-50 flex items-center justify-between px-[60px] h-[72px]">
        ...
        <div className="flex items-center gap-[36px]">
          ...
          <Link to="/about" className="text-white/90 text-[15px] font-medium flex items-center gap-[4px] hover:text-white">
            About Us <svg viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="2" className="w-[12px] h-[12px] opacity-70"><path d="M2 4l4 4 4-4" /></svg>
          </Link>
