            ...
            <div className="relative z-15 mt-[35px] max-w-[1320px] mx-auto w-full px-6 lg:px-8 flex items-center">
                ...
                <section className="flex flex-col lg:flex-row items-center justify-between gap-10 w-full">
                    ...
                    <div className="flex-1 max-w-[560px] flex flex-col justify-center">
                        ...
                        <p className="text-[15px] leading-[1.7] text-[#1f1f1f]/80 mb-6 max-w-[500px]">
                            From startups to established enterprises, <b>Effinanceforacc</b> delivers bookkeeping, accounting, payroll, tax, and financial solutions tailored to your industry's needs.
                        </p>
                        ...
                        */}
                        ...
                        <div className="relative w-full h-full flex items-end justify-center">
                            <img
                                ...
                                alt="Professional accounting and financial consulting"
